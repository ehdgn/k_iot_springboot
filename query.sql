...
-- 안전 실행: 삭제 순서
# cf) FOREINGN_KEY_CHECKS: 외래 키 제약 조건을 활성화(1)하거나 비활성화(0)하는 명령어
...
CREATE TABLE IF NOT EXISTS `order_logs` (
    ...
    message 	VARCHAR(255),
    -- 트리거가 직접 INSERT 하는 로그 테이블은 시간 누락 방지를 위해 DB 기본 값 유지
...
VALUES
	...
	(2, '광안리 푸드트럭', 'FOOD', 'BUSAN', '음식을 파는 광안리의 푸드트럭'),
...
VALUES
	...
	(2, 1, '2025-11-11', '10:00-11:00', 'CANCLLED'),
	(2, 2, '2025-11-12', '10:00-11:00', 'CONFIRMED'),
	(2, 3, '2025-11-12', '12:00-13:00', 'PENDING'),
	(3, 1, '2025-11-12', '11:00-12:00', 'CONFIRMED'),
	(3, 2, '2025-11-13', '11:00-12:00', 'PENDING'),
	(3, 3, '2025-11-13', '12:00-13:00', 'CANCLLED');
